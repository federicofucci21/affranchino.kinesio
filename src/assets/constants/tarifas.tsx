export const tarifas = [
  {
    title: "Servicios en consultorio",
    services: [
      {
        title: "R.P.G",
      ...
      },
      {
        ...
        items: ["1 Sesión $6.000.", "Tratamiento $20.000. (4 sesiones)"],
      },
    ],
  },
  {
    ...
    services: [
      ...
      {
        title:
          "Calistenia Terapéutica o Inicial (Clases Grupales) Max. 2 Personas",
        items: [
          "1 vez por semana $3.000 (p/ persona).",
          "2 veces por semana $5.000 (p/ persona).",
        ],
      },
    ],
  },
